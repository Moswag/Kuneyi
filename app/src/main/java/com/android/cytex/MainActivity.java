...
import com.android.cytex.service.ServiceUtils;
import com.android.cytex.ui.FriendsFragment;
import com.android.cytex.ui.GroupFragment;
import com.android.cytex.ui.LoginActivity;
import com.android.cytex.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("KUNEYI");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Family Chat", Toast.LENGTH_LONG).show();
            return true;
        }
