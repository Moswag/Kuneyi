...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText name,surname,phonenumber,security,editTextUsername, editTextPassword, editTextRepeatPassword;
    ...
    public void clickRegister(View view) {
        ...
        String mySecurity=security.getText().toString();
        String username = editTextUsername.getText().toString();
        String password = editTextPassword.getText().toString();
        String repeatPassword = editTextRepeatPassword.getText().toString();
        if(validate(username, password, repeatPassword)){
            Intent data = new Intent();
            data.putExtra(StaticConfig.STR_EXTRA_NAME, myName);
            data.putExtra(StaticConfig.STR_EXTRA_SURNAME, mySurname);
            data.putExtra(StaticConfig.STR_EXTRA_PHONENUMBER, myPhonenumber);
            data.putExtra(StaticConfig.STR_EXTRA_SECURITY, mySecurity);
