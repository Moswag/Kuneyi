package com.android.cytex.data;
...
public class StaticConfig {
    ...
    public static String STR_EXTRA_SURNAME = "surname";
    public static String STR_EXTRA_PHONENUMBER = "phonenumber";
    public static String STR_EXTRA_SECURITY = "security";
